...
def generate_prescription_pdf(
    ...
    try:
        ...
        disclosure_data = [[
            Paragraph(
                "[INTERRUPT] <b>AI-Assisted Prescription</b> - Generated by Dignova AI Triage Engine. "
        ...
        doc.build(story)
        print(f"[OK] ReportLab prescription generated: {file_path}")

    except Exception as e:
        print(f"[ERROR] ReportLab PDF error: {e}. Falling back to text.")
        _generate_text_prescription(patient_name, age, medications, doctor_name, file_path, diagnosis)
